const ContractUs = () => {
  return (
    <section className="py-8 dark:bg-gray-100 dark:text-gray-900 my-10 rounded-md ">
      <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
        ...
        >
          ...
          <button
            type="button"
            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-violet-600 dark:text-gray-50  bg-[#23be0a]"
          >
            Submit
          </button>
        </form>
